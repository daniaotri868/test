...
class _AppButtonState extends State<AppButton> {
      ...
      case AppButtonType.payment:
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            color: _isGray ? const Color(0xffF9FAFB) : context.colorScheme.primary,
  ...
  List<Color> get getGradientsColor {
    ...
    if (_isDark || _isPayment) {
      return [_brandPrimary.shade200,_brandPrimary.shade200];
    }
    return [];
  }
    ...
    if (widget.isLoading) {
      return Row(
        ...
        children: [
          ...
          8.horizontalSpace,
          AppText('loading', style: widget.textStyle),
          4.horizontalSpace,
        ],
      );
    }
  ...
  TextStyle getTextStyle(BuildContext context) {
    ...
    return context.textTheme.paragraph.semiBold;
  ...
  BorderRadiusGeometry? get getBorderRadius => widget.borderRadius ?? BorderRadius.circular(36.r);

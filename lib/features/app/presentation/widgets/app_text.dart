...
class AppText extends StatelessWidget {
  ...
  AppText.labelBold(
    ...
    FontWeight? fontWeight,
            ...
            textTheme.label.bold.merge(style).copyWith(fontWeight: fontWeight);
  ...
  AppText.label(
      this.text, {
        ...
        TextStyle? style,
        FontWeight? fontWeight,
      }) : style = textTheme.label.merge(style).copyWith(fontWeight: fontWeight);
  ...
  AppText.bodyLight(
    ...
    FontWeight? fontWeight,
            ...
            textTheme.body.light.merge(style).copyWith(fontWeight: fontWeight);
  ...
  AppText.bodyBold(
    ...
    FontWeight? fontWeight,
            ...
            textTheme.body.bold.merge(style).copyWith(fontWeight: fontWeight);
  ...
  AppText.footnoteLight(
    ...
    TextStyle? style,
    FontWeight? fontWeight,
  }) : style = textTheme.footnote.light
            .merge(style)
            .copyWith(fontWeight: fontWeight);
  ...
  //   TextStyle? style,
  //   FontWeight? fontWeight,
  // }) : style = textTheme.notificationItemTitle.regular
  //           .merge(style)
  //           .copyWith(fontWeight: fontWeight);
}

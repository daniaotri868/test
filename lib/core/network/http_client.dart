...
class DioClient with DioMixin implements Dio {
  ...
  DioClient(
      {required this.baseUrl, List<Interceptor> interceptors = const []}) {
    httpClientAdapter = IOHttpClientAdapter();
    options = BaseOptions(connectTimeout: Duration(seconds: 50),receiveTimeout:Duration(seconds: 50) );
    options
      ..baseUrl = baseUrl
      ..headers = {
        ...
        default:
          if (exception.error is SocketException) {
            throw AppNetworkException(
                ...
                message: AppNetworkExceptionReason.noInternet.message,
                exception: exception);
          }

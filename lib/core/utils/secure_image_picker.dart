...
class SecureFilePicker {
  ...
  static Future<File?> pickImage(ImageSource source,
      {CropAspectRatioPreset? cropAspectRatio, required BuildContext context}) async {
    ...
    if (cropAspectRatio != null) {
      final croppedFile =
          await _cropImage(compressedFile, aspectRatioPreset: cropAspectRatio, context: context);
      return croppedFile;
    }
